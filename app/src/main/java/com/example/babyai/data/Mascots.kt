...
object MascotRepository {
    ...
    val all = listOf(
        ...
        m("babydeer", "mascot_babydeer",
            "en" to "Baby Deer", "fa" to "بچه‌آهو", "sv" to "Liten hjort", "tr" to "Yavru Geyik", "de" to "Rehkitz",
        ...
        m("raccoonkit", "mascot_raccoonkit",
            "en" to "Raccoon", "fa" to "راکون", "sv" to "Liten tvättbjörn", "tr" to "Yavru Rakun", "de" to "Waschbärjunges",
            "fr" to "Bébé raton laveur", "es" to "Mapache bebé", "ru" to "Енотик", "zh" to "小浣熊", "hi" to "रैकून", "ar" to "راكون صغير"),
        m("babyotter", "mascot_babyotter",
            "en" to "Otter", "fa" to "سمور آبی", "sv" to "Utterunge", "tr" to "Yavru Su Samuru", "de" to "Otterjunges",
            "fr" to "Bébé loutre", "es" to "Nutria bebé", "ru" to "Выдрёнок", "zh" to "小水獭", "hi" to "ऊदबिलाव", "ar" to "قندس صغير"),
        m("babydolphin", "mascot_babydolphin",
            "en" to "Dolphin", "fa" to "دلفین کوچولو", "sv" to "Liten delfin", "tr" to "Yavru Yunus", "de" to "Delfinbaby",
            "fr" to "Bébé dauphin", "es" to "Delfín bebé", "ru" to "Дельфинёнок", "zh" to "小海豚", "hi" to "डॉल्फिन", "ar" to "دلفين صغير"),
        m("unicornfoal", "mascot_unicornfoal",
            "en" to "Unicorn", "fa" to "تک‌شاخ", "sv" to "Liten enhörning", "tr" to "Yavru Tekboynuz", "de" to "Einhornfohlen",
            "fr" to "Bébé licorne", "es" to "Unicornio bebé", "ru" to "Единорожек", "zh" to "小独角兽", "hi" to "यूनिकॉर्न", "ar" to "يونيكورن صغير"),
        ...
        m("pandacub", "mascot_pandacub",
            ...
            "fr" to "Bébé panda", "es" to "Panda bebé", "ru" to "Панда", "zh" to "熊猫宝宝", "hi" to "पांडा", "ar" to "باندا صغير"),
        m("penguinchick", "mascot_penguinchick",
            "en" to "Penguin", "fa" to "جوجه پنگوئن", "sv" to "Pingvinunge", "tr" to "Yavru Penguen", "de" to "Pinguinküken",
            "fr" to "Bébé pingouin", "es" to "Pingüino bebé", "ru" to "Пингвинёнок", "zh" to "小企鹅", "hi" to "पेंगुइन", "ar" to "بطريق صغير"),
        m("koalababy", "mascot_koalababy",
            "en" to "Koala", "fa" to "کوالا", "sv" to "Koalaunge", "tr" to "Yavru Koala", "de" to "Koalababy",
            "fr" to "Bébé koala", "es" to "Koala bebé", "ru" to "Коала", "zh" to "考拉宝宝", "hi" to "कोआला", "ar" to "كوالا صغير"),
        m("owlchick", "mascot_owlchick",
            "en" to "Owl", "fa" to "جوجه جغد", "sv" to "Ugglunge", "tr" to "Yavru Baykuş", "de" to "Eulenküken",
            "fr" to "Bébé hibou", "es" to "Búho bebé", "ru" to "Совёнок", "zh" to "小猫头鹰", "hi" to "उल्लू", "ar" to "بومة صغيرة"),
        ...
        m("babyelephant2", "mascot_babyelephant2",
            "en" to "Elephant", "fa" to "فیل کوچولو", "sv" to "Liten elefant", "tr" to "Yavru Fil", "de" to "Elefantenbaby",
        ...
        m("babygiraffe", "mascot_babygiraffe",
            "en" to "Giraffe", "fa" to "بچه‌زرافه", "sv" to "Giraffunge", "tr" to "Yavru Zürafa", "de" to "Giraffenbaby",
            "fr" to "Bébé girafe", "es" to "Jirafa bebé", "ru" to "Жирафёнок", "zh" to "小长颈鹿", "hi" to "जिराफ़", "ar" to "زرافة صغيرة"),
        ...
        m("babymonkey", "mascot_babymonkey",
            "en" to "Monkey", "fa" to "بچه‌میمون", "sv" to "Apunge", "tr" to "Yavru Maymun", "de" to "Affenbaby",
